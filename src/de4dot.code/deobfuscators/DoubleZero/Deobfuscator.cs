...
namespace de4dot.code.deobfuscators.DoubleZero {
	public class DeobfuscatorInfo : DeobfuscatorInfoBase {
		public const string THE_NAME = "DoubleZero Obfuscator"; // Obfuscator name
		public const string THE_TYPE = "dblz"; // Obfuscator short name
	...
	public class Deobfuscator : DeobfuscatorBase {
		...
		public override IEnumerable<IBlocksDeobfuscator> BlocksDeobfuscators {
			// Here we register a block deobfuscator that performs unflattening
			get {
